...
5. **Реальный ночной аудит 14 сентября 2026.** В [запуске OpenCode](https://github.com/k-tarasov/ai-for-developers-project-387/actions/runs/34854788627) получены performance 76, accessibility 100, best practices 96 и SEO 82. Агент создал [issue #9](https://github.com/k-tarasov/ai-for-developers-project-387/issues/9), отчёт сохранён в артефакте. Красный статус ожидаем: performance ниже порога 80; порог ради зелёного статуса не снижался.
6. **Неинтерактивные разрешения.** Первый [запуск исправлений PR #7](https://github.com/k-tarasov/ai-for-developers-project-387/actions/runs/34853575274) остановился по таймауту: после подготовки правок агент ожидал разрешения для `/tmp`. В workflow добавлены явные правила временных каталогов вместо увеличения таймаута. Этот случай показал, что проверять нужно и окружение агента, а не только его промпт.
